...
import org.apache.tinkerpop.gremlin.util.ser.GraphBinaryMessageSerializerV1SkipDeser;
 ...
 */
public class WebSocketClient2 extends AbstractClient {
    private static final Logger logger = LoggerFactory.getLogger(WebSocketClient2.class);
    ...
    public WebSocketClient2(final URI uri) {
        super("ws-client-%d");
        ...
        try {
            ...
            final MessageSerializer<GraphBinaryMapper> skipDeserializer = new GraphBinaryMessageSerializerV1SkipDeser();
