...
import org.apache.tinkerpop.gremlin.driver.simple.WebSocketClient2;
...
public final class TestClientFactory {
    ...
    public static WebSocketClient createWebSocketClient(URI webSocketURI) {
        return new WebSocketClient(webSocketURI);
    }

    public static WebSocketClient2 createWebSocketClientSkipDeser(URI webSocketURI) {
        return new WebSocketClient2(webSocketURI);
    }
