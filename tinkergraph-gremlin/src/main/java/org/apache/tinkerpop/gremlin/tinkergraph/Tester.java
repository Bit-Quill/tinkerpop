...
public class Tester {
    ...
    public static void runFunctionalUpdateVertexPropertyTest() {
        ...
        properties.add(CollectionFactory.asMap("a", "1", "b", "1", "c", "1", "d", "1", "e", "1"));
        properties.add(CollectionFactory.asMap("a", "2", "b", "2", "c", "2", "d", "2", "e", "2"));
        properties.add(CollectionFactory.asMap("a", "3", "b", "3", "c", "3", "d", "3", "e", "3"));
        properties.add(CollectionFactory.asMap("a", "4", "b", "4", "c", "4", "d", "4", "e", "4"));
        properties.add(CollectionFactory.asMap("a", "5", "b", "5", "c", "5", "d", "5", "e", "5"));
    ...
    public static void runFunctionalRollbackVertexPropertyTest() {
        ...
        GraphTraversalSource g = createGraph().traversal();
        Vertex v = g.addV().property(CollectionFactory.asMap("a", "7", "b", "7", "c", "7", "d", "7", "e", "7")).next();
        Commit(g);
        Object vId = v.id();
    ...
    public static void runFunctionalRollbackEdgePropertyTest() {
        ...
        GraphTraversalSource g = createGraph().traversal();
        g.addV().as("a").addV().as("b").addE("edge").from("a").to("b").iterate();
        g.E().property(CollectionFactory.asMap("a", "7", "b", "7", "c", "7", "d", "7", "e", "7")).iterate();
        Commit(g);
