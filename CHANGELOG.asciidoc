...
* Added user agent to web socket handshake in dotnet driver. Can be controlled by EnableUserAgentOnConnect in `ConnectionPoolSettings`. It is enabled by default.
