...
As of TinkerPop 3.5.5, environment configuration for Gremlin Language Variants can be optional, as Docker becomes a system
requirement to build and test GLVs inside of Maven. Docker enables the building and testing of the GLVs without the need to install GLV-specific environments.
Please make sure Docker is installed and running on your system. You will need to install both link:https://docs.docker.com/engine/install/[Docker Engine]
and link:https://docs.docker.com/compose/install/[Docker Compose], which are included in link:https://docs.docker.com/desktop/[Docker Desktop].
This set up uses Docker Compose, details on running
...
[[docker-testing]]
== Testing GLVs with Docker

Currently gremlin-go, gremlin-javascript, gremlin-dotnet, gremlin-python and gremlin-console can be tested through Docker using
Docker Compose.

Please make sure Docker is installed and running on your system. 
You will need to install both link:https://docs.docker.com/engine/install/[Docker Engine] and link:https://docs.docker.com/compose/install/[Docker Compose],
