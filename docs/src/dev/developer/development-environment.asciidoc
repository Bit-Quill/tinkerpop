...
Some GLV allow you to run tests without setting up Java and without building of other parts of the server. Currently
supported gremlin-go, gremlin-javascript, gremlin-dotnet, gremlin-python and gremlin-console.
